...
public class MyGenericDAOImpl<T, ID extends Serializable> extends
		MyHibernateBaseDAO implements GenericDAO<T, ID> {

	protected Class<T> persistentClass = (Class<T>) DAOUtil.getTypeArguments(MyGenericDAOImpl.class, this.getClass()).get(0);
